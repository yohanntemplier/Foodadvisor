 ...
 */
final class Version20191219133958 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE restaurant DROP pictures');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caracteristic_restaurant (caracteristic_id INT NOT NULL, restaurant_id INT NOT NULL, INDEX IDX_119595FE81194CF4 (caracteristic_id), INDEX IDX_119595FEB1E7706E (restaurant_id), PRIMARY KEY(caracteristic_id, restaurant_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE paiement_restaurant (paiement_id INT NOT NULL, restaurant_id INT NOT NULL, INDEX IDX_7D5A7CCF2A4C4478 (paiement_id), INDEX IDX_7D5A7CCFB1E7706E (restaurant_id), PRIMARY KEY(paiement_id, restaurant_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE restaurant ADD pictures VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
